...
static const float kGapMultiplier = 1.5;
...
static NSString *const kFontName = @"Avenir";
...
//    NSArray *textureNames = @[@"Bird0", @"Bird1", @"Bird2", @"Bird3", @"button_learn", @"Button", @"ButtonSquare", @"Cactus", @"GameOver", @"Ground", @"Logo", @"OK", @"Pause", @"Play", @"Rate", @"Score", @"Scorecard", @"Share", @"Sombrero"];
//    _textures = [NSMutableArray array];
//    for (int i = 0; i < textureNames.count; i++) {
//      [_textures addObject:[SKTexture textureWithImageNamed:textureNames[i]]];
//    }
//    [SKTexture preloadTextures:_textures withCompletionHandler:^{
...
- (void)setupPlayer {
  ...
  // Player movement on main menu

  SKAction *moveUp = [SKAction moveByX:0 y:30 duration:1.0];
...
- (void)setupScoreLabel {
  ...
  _scoreLabel.fontColor = [SKColor colorWithRed:54.0/255 green:193.0/255 blue:228.0/255 alpha:1.0];
  _scoreLabel.position = CGPointMake(self.size.width * 0.85, self.size.height * 1.01 - kMargin);
  _scoreLabel.text = @"0";
...
- (void)setupScorecard {
  ...
  scorecard.position = CGPointMake(self.size.width * 0.57, self.size.height/2);
  ...
  lastScore.fontColor = [SKColor colorWithRed:234.0/255 green:124.0/255 blue:156.0/255 alpha:1.0];
  lastScore.position = CGPointMake(-scorecard.size.width * .25, -scorecard.size.height * 0.2);
  lastScore.text = [NSString stringWithFormat:@"%d", _score];
  [scorecard addChild:lastScore];
  
 //Score Color 234, 124, 156
    
  SKLabelNode *bestScore = [[SKLabelNode alloc] initWithFontNamed:kFontName];
  bestScore.fontColor = [SKColor colorWithRed:234.0/255 green:124.0/255 blue:156.0/255 alpha:1.0];
  bestScore.position = CGPointMake(scorecard.size.width * 0.20, -scorecard.size.height * 0.2);
 ...
 // [_worldNode addChild:gameOver];
  ...
  SKSpriteNode *okButton = [SKSpriteNode spriteNodeWithImageNamed:@"restart"];
  okButton.position = CGPointMake(self.size.width * 0.49, self.size.height * 0.72 - scorecard.size.height/2 - kMargin - okButton.size.height * 0.5);
  okButton.zPosition = LayerUI;
  [_worldNode addChild:okButton];
  
  //SKSpriteNode *ok = [SKSpriteNode spriteNodeWithImageNamed:@"restart"];
...
//SKSpriteNode *shareButton = [SKSpriteNode spriteNodeWithImageNamed:@"Button.png"];
  ...
  scorecard.position = CGPointMake(self.size.width * 0.47, -scorecard.size.height/2);
...
- (void)setupMainMenu {
  ...
  SKSpriteNode *playButton = [SKSpriteNode spriteNodeWithImageNamed:@"start-button.png"];
  ...
  rateButton.position = CGPointMake(self.size.width * 0.85, self.size.height * 0.35);
...
- (SKSpriteNode *)createBlender {
    SKSpriteNode *sprite = [SKSpriteNode spriteNodeWithImageNamed:@"Blender"];
...
- (SKSpriteNode *)createObstacle {
    SKSpriteNode *sprite = [SKSpriteNode spriteNodeWithImageNamed:@"Arms"];
    sprite.userData = [NSMutableDictionary dictionary];
    sprite.zPosition = LayerObstacle;

    CGPathRef path = [UIBezierPath bezierPathWithRect:sprite.frame].CGPath;
    sprite.physicsBody = [SKPhysicsBody bodyWithPolygonFromPath:path];
...
- (void)spawnObstacle {
  ...
  [_worldNode addChild:bottomObstacle];
    ...
    // blender
    SKSpriteNode *blender = [self createBlender];
    blender.name = @"BottomObstacle";
    blender.position = CGPointMake(startX, 220);
    [_worldNode addChild:blender];
...
- (void)rateApp {
  ...
  NSString *urlString = [NSString stringWithFormat:@"http:www.superfruits.com", APP_STORE_ID];
